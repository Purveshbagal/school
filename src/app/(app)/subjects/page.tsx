...
export default async function SubjectsPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Subjects"
        description="Pick a standard to manage its subjects"
      />
                ...
                {standards.map((s) => (
                  <div key={s.id} className="flex items-center justify-between gap-2 rounded-xl border border-border p-3.5">
                    <div>
                      ...
                      <Badge variant="secondary" className="mt-1.5">{s._count.subjects} subjects</Badge>
                    </div>
                ...
                <TableBody>
                  {standards.map((s) => (
                    <TableRow key={s.id}>
                      ...
                      <TableCell>
                        <Badge variant="secondary">{s._count.subjects} subjects</Badge>
                      </TableCell>
