...
export default async function TeacherAdvanceHistoryPage({
  ...
  const outstanding = allAdvances.reduce((sum, a) => sum + Math.max(0, a.amount - a.adjustedAmount), 0);
                  ...
                  <div key={a.id} className="rounded-lg border border-border p-3">
                    ...
                    <div className="mt-2 flex justify-end gap-1">
                      <Button
                        ...
                        render={<Link href={`/advance-payments/entries/${a.id}/schedule`}><CalendarClock /></Link>}
                      />
